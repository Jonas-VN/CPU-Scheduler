...
def calc_percentile(scheduled, x):
...
def calculate_average(scheduled):
    ...
    print("Average waiting time: " + str(gemiddelde_waiting_time))
    print("Average turnaround time: " + str(gemiddelde_turnaround_time))
    print("Average response ratio: " + str(gemiddelde_response_ratio))